      ...
      <div className="flex flex-col pt-[23px] lg:pt-[37px]">
        {services.map((service, index) => (
          ...
          >
            <div>
              <div
                className="lg:w-[1025px] text-[1em] leading-[22px] lg:text-[1.625em] lg:leading-[34px]"
                dangerouslySetInnerHTML={{ __html: service.description }}
              />
              {service.image.url && (
                <img
                  src={service.image.url}
                  className="object-cover h-[200px] md:h-[450px] lg:h-[754px] xl:h-[780px] w-full pt-[20px] lg:pt-[75px]"
                />
              )}
            </div>
          </Accordion>
