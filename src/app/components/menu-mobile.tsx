    ...
    <>
      <header className="block lg:hidden bg-page sticky top-0 z-[1000]">
        ...
        >
          ...
          <img
            className="block md:hidden cursor-pointer h-[10px] w-[25px]"
...
<div
  className={`fixed top-0 left-0 z-[2000] w-full h-[100vh] bg-[#D3C6B8] transition-transform transform ${
    menuOpen ? "translate-x-0" : "-translate-x-full"
  }`}
>
  <div className="h-full flex flex-col justify-between">
    <div>
      <div className="pl-[10px] bg-white items-center flex justify-between h-[50px]">
        <Link href="/">
          <p className="text-[20px] leading-[26px]">
            Local Architecture Studio.
          </p>
        ...
        <img
          className="cursor-pointer h-[10px] w-[25px]"
          src="/images/icons/less.svg"
          onClick={() => setMenuOpen(false)}
        />
      </div>
